    ...
    <div>
      ...
      <S.Container ref={outerDivRef} id="container" className="outer">
        <S.ContentContainer>
          <S.ContentWrapper>
            ...
            <S.Text>
              <S.Line style={{ marginRight: "1em" }} /> DAOOM <S.Line />
            </S.Text>
          </S.ContentWrapper>
        </S.ContentContainer>
      ...
      <S.VideoContainer>
        <S.Video
          ...
          num={7}
          effectControl={effectControl}
          src="/videos/mountainMeadow2.mp4"
          loop
          autoPlay
          muted
        />
